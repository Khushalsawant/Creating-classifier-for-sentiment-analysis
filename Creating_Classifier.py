...
#print(broken_number_of_parts[-len(broken_number_of_parts)])
#broken_number_of_parts_2D = np.reshape(broken_number_of_parts, (-1, 2))
 

def create_raw_data_for_classifier(start_pt,end_pt,return_raw_data):
    # printing process id 
    ...
    print(raw_data[0])
    return_raw_data = raw_data

def create_raw_data_for_classifier1(start_pt,end_pt):
    # printing process id 
    #print("ID of process running : {}".format(os.getpid()))
...
def get_the_classifier_accuracy(raw_data,return_dt_classifier_accuracy,return_NaiveBayesClassifier):
    ...
    return_dt_classifier_accuracy = dt_classifier
    return_NaiveBayesClassifier = classifier


def get_the_classifier_accuracy1(raw_data):
    np.random.shuffle(raw_data)
    training = raw_data[:5000]
    testing = raw_data[-5000:]
    ...
    print ("classifier.accuracy = ",classifier.accuracy(testing))
    print ("dt_classifier.accuracy = ",dt_classifier.accuracy(testing))
    return dt_classifier,classifier
